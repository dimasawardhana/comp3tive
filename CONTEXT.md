...
**Dashboard**:
The hub the app opens on. It shows the active community's state at a glance — players on the roster, saved squads, tournaments, and teasers of the most recent players and active tournaments — and the most likely next actions.
...
**Landing Page**:
The public page at the site root, outside the app: it explains what comp3tive is and links into the app. It holds no domain records, is never community-scoped, and is not the Dashboard — an organizer who already uses comp3tive may never see it.
_Avoid_: homepage, home, splash screen, intro screen
