...
- **Visual design**: the direction is captured in the design reference (token system, type pairing, dark mode, copy voice) with a working prototype in the repo; the UI tickets follow it as the visual contract.
